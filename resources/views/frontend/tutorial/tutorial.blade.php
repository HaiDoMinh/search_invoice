...
@section('content')
    <div class="content-box">
        <div class="container content">
            ...
            <p>Bước 3: Nhập Mã kiểm tra và nhấn vào nút Tra cứu hóa đơn để tra cứu hóa đơn với thông tin đã nhập</p>

            <p>Bước 4: Màn hình sẽ hiển thị thông tin chi tiết về hóa đơn và hiển thị 2 tệp hóa đơn đính kèm định dạng .zip và .pdf, bạn có thể tùy chọn:</p>
